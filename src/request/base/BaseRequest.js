...
const API = 'https://utm07.duckdns.org/celery';
// const API = 'https://ipsmanager.duckdns.org';
...
export default class BaseRequest {
  ...
  async postTo(url, data = {}) {
    const headers = { 'Access-Control-Allow-Origin': '*','kbn-xsrf': 'true'};
    try {
      console.log('postTo', url)
