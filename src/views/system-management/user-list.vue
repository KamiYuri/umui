<template>
  <div class="app-container user-management">
    <div class="filter-container">
      ...
      <el-button style="float: right; margin-left: 10px;" class="filter-item float-right" @click="exportCSV($refs.elTable, 'user-list')">
        {{ $t('table.export-csv') }}
      </el-button>
      <el-button style="float: right;" class="filter-item float-right" @click="exportXLS($refs.elTable, 'user-list')">
        {{ $t('table.export-xls') }}
      </el-button>
    </div>
