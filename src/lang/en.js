 export default {
  route: {
    ...
    blacklisting: 'Blacklist Data',
    virtualpatching: 'Virtual Patching',
    malwarebehavior: 'Malware Behavior',
    modsec_ruleset: 'WAF Ruleset',
    suricata_ruleset: 'UTM Ruleset',
    ...
    hostoverview: 'Host Info',
    containeroverview: 'Container Info',
    hostipsalert: "Alert",
    ips_list: 'Node List',
    ...
    overview: 'Overview',
    scan_file: 'Scan File',
    scan_observable: 'Scan Observable',
    analyzer: 'Analyzer',
    connector: 'Connector',
  ...
  upload: {
    ...
    dropsqlHere: "Drop SQL file here",
    or: "or",
